- dashboard: main_dashboard__marketing_case
  ...
  - type: button
    ...
    rich_content_json: '{"text":"Send selection","description":"Send your selection
      ...
      "href":"https://crystalloids.eu.looker.com/looks/56?fields=orders.shipping_address_country_code&f[orders.shipping_address_country_code]={{ shipping_address_country_code._value }}"}'
    row: 2
    col: 16
    width: 7
    height: 2
